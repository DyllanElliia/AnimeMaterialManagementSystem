...
BEGIN
	...
	select picture_id into Pictureid_ from all_show where user_id=userid_ and picture_address=pictureAddress_;
	
	select folder_id into newFolderID from all_show 
	...
	select folder_id into newFolderID from folder_ 
	where folder_name=new_folder_name_ and user_id=userid_;
